...
(function(){
  ...
  function ensurePanel(){
    ...
    panel.innerHTML=`<button class="gone-editor-config-btn" type="button" title="Configurações do Master">⚙️ Configurações</button>
